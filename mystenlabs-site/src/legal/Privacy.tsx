    ...
    return (
        <>
            <LegalTitle
                ...
                subTitle="Last Updated: March 16, 2022"
            />
            {/* prettier-ignore */}
            <pre className='pre-wrap mt-25'>{
...
Category of Personal Information Collected by Mysten Labs 	a) Identifiers 
A real name, postal address, unique personal identifier, online identifier, Internet Protocol address, email address, account name, or other similar identifiers.b) Personal information categories listed in Cal. Civ. Code § 1798.80(e)
...
Browsing history, search history, information on a consumer’s interaction with an internet website, application, or advertisement.f) Professional or employment-related information
Current or past job history or performance evaluations.g) Inferences drawn from other personal information to create a profile about a consumer
Profile reflecting a consumer’s preferences, characteristics, psychological trends, predispositions, behavior, attitudes, intelligence, abilities, and aptitudes.Categories of Third Parties Personal Information is Disclosed to for a Business Purpose
a) 
Service providers
